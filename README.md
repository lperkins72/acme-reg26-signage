...
```text
?tenant=acme&region=reg26&device=nuc-001
```

Example:

```text
https://<deployment-domain>/?tenant=acme&region=reg26&device=nuc-001
```
...
5. test one launcher such as `/devices/reg26/nuc-001.html`
